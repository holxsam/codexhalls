...
// export const INITIAL_ROTATION: Vector3Array = [
//   0.123207539918971, 0.576844610366985, 0.4975666687236977,
// ];
// export const INITIAL_SCALE = 0.6;
// export const MINIMIZED_SCALE = 0.1;

export const INITIAL_POSITION: Vector3Array = [0, -50, 0];
export const INITIAL_ROTATION: Vector3Array = [Math.PI / 4, Math.PI / 4, 0];
export const INITIAL_SCALE = 1.3;
export const MINIMIZED_SCALE = 0.25;
